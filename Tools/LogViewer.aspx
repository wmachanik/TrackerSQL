...
<asp:Content ID="cntLogViewerBdy" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlLogViewer" runat="server" CssClass="simpleForm page-tone-panel page-tone-logs">
        <div class="page-tone-header tool-card-header">
            <img class="tool-card-icon" src="../images/imgButtons/View.png" alt="" />
            <div>
                <h1 class="page-tone-title">Log Viewer</h1>
                <p class="page-tone-subtitle">Review system logs</p>
            </div>
        </div>

        <asp:UpdatePanel ID="upnlSelection" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="page-tone-toolbar filter-toolbar" runat="server">
