...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [HolidayClosuresTbl] ([HolidayClosureID], [ClosureDate], [DaysClosed], [AppliesToPrep], [AppliesToDelivery], [ShiftStrategy], [Description]) SELECT NULLIF([ID], N'''') AS [HolidayClosureID], CASE WHEN NULLIF([ClosureDate], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([ClosureDate], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N'''')), CAST(NULL AS datetime2(7))) END AS [ClosureDate], NULLIF([DaysClosed], N'''') AS [DaysClosed], NULLIF([AppliesToPrep], N'''') AS [AppliesToPrep], NULLIF([AppliesToDelivery], N'''') AS [AppliesToDelivery], NULLIF([ShiftStrategy], N'''') AS [ShiftStrategy], CASE WHEN NULLIF([Description], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'''')), CAST(NULL AS datetime2(7))) END AS [Description] FROM [AccessSrc].[HolidayClosureTbl];';
    BEGIN TRY
        BEGIN TRAN;
        ...
        SELECT
            NULLIF([ID], N'') AS [HolidayClosureID], CASE WHEN NULLIF([ClosureDate], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([ClosureDate], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N'')), CAST(NULL AS datetime2(7))) END AS [ClosureDate], NULLIF([DaysClosed], N'') AS [DaysClosed], NULLIF([AppliesToPrep], N'') AS [AppliesToPrep], NULLIF([AppliesToDelivery], N'') AS [AppliesToDelivery], NULLIF([ShiftStrategy], N'') AS [ShiftStrategy], CASE WHEN NULLIF([Description], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'')), CAST(NULL AS datetime2(7))) END AS [Description]
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [HolidayClosuresTbl] ([HolidayClosureID], [ClosureDate], [DaysClosed], [AppliesToPrep], [AppliesToDelivery], [ShiftStrategy], [Description]) SELECT NULLIF([ID], N'''') AS [HolidayClosureID], CASE WHEN NULLIF([ClosureDate], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([ClosureDate], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([ClosureDate], N'''')), CAST(NULL AS datetime2(7))) END AS [ClosureDate], NULLIF([DaysClosed], N'''') AS [DaysClosed], NULLIF([AppliesToPrep], N'''') AS [AppliesToPrep], NULLIF([AppliesToDelivery], N'''') AS [AppliesToDelivery], NULLIF([ShiftStrategy], N'''') AS [ShiftStrategy], CASE WHEN NULLIF([Description], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'''')), CAST(NULL AS datetime2(7))) END AS [Description] FROM [HolidayClosureTbl];';
    BEGIN TRY
        BEGIN TRAN;
        SET IDENTITY_INSERT [HolidayClosuresTbl] ON;
        INSERT INTO [HolidayClosuresTbl]
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [ItemPackagingsTbl] ([ItemPackagingID], [ItemPrepDescription], [AdditionalNotes], [Symbol], [Colour], [BGColour]) SELECT NULLIF([PackagingID], N'''') AS [ItemPackagingID], CASE WHEN NULLIF([Description], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'''')), CAST(NULL AS datetime2(7))) END AS [ItemPrepDescription], NULLIF([AdditionalNotes], N'''') AS [AdditionalNotes], NULLIF([Symbol], N'''') AS [Symbol], NULLIF([Colour], N'''') AS [Colour], NULLIF([BGColour], N'''') AS [BGColour] FROM [AccessSrc].[PackagingTbl];';
    BEGIN TRY
        BEGIN TRAN;
        ...
        SELECT
            NULLIF([PackagingID], N'') AS [ItemPackagingID], CASE WHEN NULLIF([Description], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'')), CAST(NULL AS datetime2(7))) END AS [ItemPrepDescription], NULLIF([AdditionalNotes], N'') AS [AdditionalNotes], NULLIF([Symbol], N'') AS [Symbol], NULLIF([Colour], N'') AS [Colour], NULLIF([BGColour], N'') AS [BGColour]
        FROM [AccessSrc].[PackagingTbl];
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [ItemUnitsTbl] ([ItemUnitID], [UnitOfMeasure], [UnitDescription]) SELECT NULLIF([ItemUnitID], N'''') AS [ItemUnitID], NULLIF([UnitOfMeasure], N'''') AS [UnitOfMeasure], CASE WHEN NULLIF([UnitDescription], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([UnitDescription], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N'''')), CAST(NULL AS datetime2(7))) END AS [UnitDescription] FROM [AccessSrc].[ItemUnitsTbl];';
    BEGIN TRY
        BEGIN TRAN;
        ...
        SELECT
            NULLIF([ItemUnitID], N'') AS [ItemUnitID], NULLIF([UnitOfMeasure], N'') AS [UnitOfMeasure], CASE WHEN NULLIF([UnitDescription], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([UnitDescription], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([UnitDescription], N'')), CAST(NULL AS datetime2(7))) END AS [UnitDescription]
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [PeopleTbl] ([PersonID], [Person], [Abbreviation], [Enabled], [NormalDeliveryDoW], [SecurityUsername]) SELECT NULLIF([PersonID], N'''') AS [PersonID], CASE WHEN NULLIF([Person], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Person], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Person], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Person], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Person], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Person], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Person], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Person], N'''')), CAST(NULL AS datetime2(7))) END AS [Person], CASE WHEN NULLIF([Abreviation], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Abreviation], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N'''')), CAST(NULL AS datetime2(7))) END AS [Abbreviation], CASE WHEN NULLIF([Enabled], N'''') IS NULL THEN NULL WHEN NULLIF([Enabled], N'''') IN (N''1'', N''-1'', N''true'', N''TRUE'', N''yes'', N''YES'', N''Y'', N''y'') THEN 1 WHEN NULLIF([Enabled], N'''') IN (N''0'', N''false'', N''FALSE'', N''no'', N''NO'', N''N'', N''n'') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([Enabled], N'''')) END AS [Enabled], NULLIF([NormalDeliveryDoW ... [truncated]';
    BEGIN TRY
        BEGIN TRAN;
        ...
        SELECT
            NULLIF([PersonID], N'') AS [PersonID], CASE WHEN NULLIF([Person], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Person], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Person], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([Person], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([Person], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([Person], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([Person], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([Person], N'')), CAST(NULL AS datetime2(7))) END AS [Person], CASE WHEN NULLIF([Abreviation], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Abreviation], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([Abreviation], N'')), CAST(NULL AS datetime2(7))) END AS [Abbreviation], CASE WHEN NULLIF([Enabled], N'') IS NULL THEN NULL WHEN NULLIF([Enabled], N'') IN (N'1', N'-1', N'true', N'TRUE', N'yes', N'YES', N'Y', N'y') THEN 1 WHEN NULLIF([Enabled], N'') IN (N'0', N'false', N'FALSE', N'no', N'NO', N'N', N'n') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([Enabled], N'')) END AS [Enabled], NULLIF([NormalDeliveryDoW], N'') AS [NormalDeliveryDoW], NULLIF([SecurityUsername], N'') AS [SecurityUsername]
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [ItemServiceTypesTbl] ([ItemServiceTypeID], [ItemServiceType], [Description], [ItemPackagingID], [ItemPrepTypeID]) SELECT NULLIF([ServiceTypeId], N'''') AS [ItemServiceTypeID], NULLIF([ServiceType], N'''') AS [ItemServiceType], CASE WHEN NULLIF([Description], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'''')), CAST(NULL AS datetime2(7))) END AS [Description], NULLIF([PackagingID], N'''') AS [ItemPackagingID], NULLIF([PrepTypeID], N'''') AS [ItemPrepTypeID] FROM [AccessSrc].[ServiceTypesTbl];';
    BEGIN TRY
        BEGIN TRAN;
        ...
        SELECT
            NULLIF([ServiceTypeId], N'') AS [ItemServiceTypeID], NULLIF([ServiceType], N'') AS [ItemServiceType], CASE WHEN NULLIF([Description], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'')), CAST(NULL AS datetime2(7))) END AS [Description], NULLIF([PackagingID], N'') AS [ItemPackagingID], NULLIF([PrepTypeID], N'') AS [ItemPrepTypeID]
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [ItemServiceTypesTbl] ([ItemServiceTypeID], [ItemServiceType], [Description], [ItemPackagingID], [ItemPrepTypeID]) SELECT NULLIF([ServiceTypeId], N'''') AS [ItemServiceTypeID], NULLIF([ServiceType], N'''') AS [ItemServiceType], CASE WHEN NULLIF([Description], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Description], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Description], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Description], N'''')), CAST(NULL AS datetime2(7))) END AS [Description], NULLIF([PackagingID], N'''') AS [ItemPackagingID], NULLIF([PrepTypeID], N'''') AS [ItemPrepTypeID] FROM [ServiceTypesTbl];';
    BEGIN TRY
        BEGIN TRAN;
        SET IDENTITY_INSERT [ItemServiceTypesTbl] ON;
        INSERT INTO [ItemServiceTypesTbl]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            NULLIF([ClientUsageLineNo], N'') AS [ContactsItemSvcSummaryId], NULLIF([CustomerID], N'') AS [ContactID], [Date] AS [UsageDate], NULLIF([CupCount], N'') AS [CupCount], NULLIF([ServiceTypeId], N'') AS [ItemServiceTypeID], NULLIF([Qty], N'') AS [Qty], NULLIF([Notes], N'') AS [Notes]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            NULLIF([CustomerId], N'') AS [ContactID], CASE WHEN NULLIF([LastCupCount], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([LastCupCount], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([LastCupCount], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([LastCupCount], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([LastCupCount], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([LastCupCount], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([LastCupCount], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([LastCupCount], N'')), CAST(NULL AS datetime2(7))) END AS [LastCupCount], [NextCoffeeBy] AS [NextCoffeeBy], [NextCleanOn] AS [NextCleanOn], [NextFilterEst] AS [NextFilterEst], [NextDescaleEst] AS [NextDescaleEst], [NextServiceEst] AS [NextServiceEst], CASE WHEN NULLIF([DailyConsumption], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([DailyConsumption], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([DailyConsumption], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([DailyConsumption], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([DailyConsumption], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([DailyConsumption], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([DailyConsumption], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([DailyConsumption], N'')), CAST(NULL AS datetime2(7))) END AS [DailyConsumption], NULLIF([FilterAveCount], N'') AS [FilterAveCount], NULLIF([DescaleAveCount], N'') AS [DescaleAveCount], NULLIF([ServiceAveCount], N'') AS [ServiceAveCount], NULLIF([CleanAveCount], N'') AS [CleanAveCount]
