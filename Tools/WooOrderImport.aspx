...
<asp:Content ID="cntWooOrderImportBdy" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="smWooOrderImport" runat="server" EnablePartialRendering="true" AsyncPostBackTimeout="600" />

    <asp:UpdateProgress ID="upgWooOrderImport" runat="server" AssociatedUpdatePanelID="upnlWooOrderImport"
        DisplayAfter="0" DynamicLayout="true">
        <ProgressTemplate>
            <div class="status-message status-info page-tone-progress" role="status" aria-live="polite">
    ...
    <asp:UpdatePanel ID="upnlWooOrderImport" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="ddlMode" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="btnPull" EventName="Click" />
        </Triggers>
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" CssClass="simpleForm page-tone-panel page-tone-tools">
                ...
                <div class="complex-form-section">
                    ...
                    <div class="filter-toolbar">
                        <div class="filter-section">
                            ...
                            <asp:Button ID="btnRefreshFromWoo" runat="server" CssClass="filter-panel-btn" Text="Refresh from Woo"
                                OnClick="btnRefreshFromWoo_Click" CausesValidation="false"
                                ToolTip="Re-fetch current preview orders from WooCommerce" />
                                    ...
                                    <span class="toolbar-icon-row woo-import-row-actions">
                                        ...
                                        <asp:PlaceHolder runat="server" Visible='<%# (bool)Eval("CanUpdateContact") %>'>
                                            <asp:ImageButton ID="btnUpdateContact" runat="server"
                                                ...
                                                CommandArgument='<%# Eval("WooOrderId") %>'
                                                CausesValidation="false"
                                                OnClientClick='<%# GetUpdateContactClientClick(Container.DataItem) %>' />
                                        </asp:PlaceHolder>
                                    </span>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="pnlCompanyNamePrompt" runat="server" CssClass="confirm-modal-overlay" Visible="false">
                    <div class="confirm-modal">
                        <h2><asp:Literal ID="litCompanyPromptTitle" runat="server" /></h2>
                        <p><asp:Literal ID="litCompanyPromptBody" runat="server" /></p>
                        <asp:HiddenField ID="hdnPendingUpdateWooOrderId" runat="server" />

                        <asp:Panel ID="pnlCompanyChoice" runat="server" Visible="false" CssClass="confirm-modal-option">
                            <asp:Label ID="lblCompanyChoice" runat="server" Text="Company name:" AssociatedControlID="rblCompanyNameMode" />
                            <asp:RadioButtonList ID="rblCompanyNameMode" runat="server" RepeatDirection="Vertical" CssClass="woo-import-company-mode" />
                        </asp:Panel>

                        <div class="confirm-modal-option">
                            <asp:CheckBox ID="chkUpdateAddress" runat="server" />
                            <div class="woo-map-section-note"><asp:Literal ID="litUpdateAddressDetail" runat="server" /></div>
                        </div>
                        <div class="confirm-modal-option">
                            <asp:CheckBox ID="chkUpdatePhone" runat="server" />
                            <div class="woo-map-section-note"><asp:Literal ID="litUpdatePhoneDetail" runat="server" /></div>
                        </div>
                        <asp:Panel ID="pnlPhoneSkipHint" runat="server" Visible="false" CssClass="woo-map-section-note">
                            <asp:Literal ID="litPhoneSkipHint" runat="server" />
                        </asp:Panel>
                        <div class="confirm-modal-option">
                            <asp:CheckBox ID="chkUpdateAltEmail" runat="server" />
                            <div class="woo-map-section-note"><asp:Literal ID="litUpdateAltEmailDetail" runat="server" /></div>
                        </div>
                        <div class="confirm-modal-option">
                            <asp:CheckBox ID="chkUpdatePersonNames" runat="server" />
                            <div class="woo-map-section-note"><asp:Literal ID="litUpdatePersonNamesDetail" runat="server" /></div>
                        </div>

                        <div class="button-row confirm-modal-buttons">
                            <asp:Button ID="btnCompanyPromptConfirm" runat="server" CssClass="filter-panel-btn"
