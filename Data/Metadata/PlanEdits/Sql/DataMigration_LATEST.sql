...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [ContactsItemSvcSummaryTbl] ([ContactsItemSvcSummaryId], [ContactID], [UsageDate], [CupCount], [ItemServiceTypeID], [Qty], [Notes]) SELECT NULLIF([ClientUsageLineNo], N'''') AS [ContactsItemSvcSummaryId], NULLIF([CustomerID], N'''') AS [ContactID], CASE WHEN NULLIF([Date], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([Date], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([Date], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([Date], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([Date], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([Date], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([Date], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([Date], N'''')), CAST(NULL AS datetime2(7))) END AS [UsageDate], NULLIF([CupCount], N'''') AS [CupCount], NULLIF([ServiceTypeId], N'''') AS [ItemServiceTypeID], NULLIF([Qty], N'''') AS [Qty], NULLIF([Notes], N'''') AS [Notes] FROM [AccessSrc].[ClientUsageLinesTbl];';
    BEGIN TRY
        BEGIN TRAN;
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [RepairsTbl] ([RepairID], [ContactID], [ContactName], [ContactEmail], [JobCardNumber], [DateLogged], [LastStatusChange], [EquipTypeID], [EquipSerialNumber], [SwopOutMachineID], [EquipConditionID], [TakenFrother], [TakenBeanLid], [TakenWaterLid], [BrokenFrother], [BrokenBeanLid], [BrokenWaterLid], [RepairFaultID], [RepairFaultDesc], [RepairStatusID], [RelatedOrderID], [Notes]) SELECT NULLIF([RepairID], N'''') AS [RepairID], NULLIF([CustomerID], N'''') AS [ContactID], NULLIF([ContactName], N'''') AS [ContactName], NULLIF([ContactEmail], N'''') AS [ContactEmail], NULLIF([JobCardNumber], N'''') AS [JobCardNumber], CASE WHEN NULLIF([DateLogged], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([DateLogged], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([DateLogged], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([DateLogged], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([DateLogged], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([DateLogged], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([DateLogged], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([DateLogged], N'''')), CAST(NULL AS datetime2(7))) END AS [DateLogged], NULLIF([LastStatusChange], N'''') AS [LastStatusChange], NULLIF([MachineTypeID], N'''') AS [EquipTypeID], NULLIF([MachineSerialNumber], N'''') AS [EquipSerialNumber], NULLIF([SwopOutMachineID], N'''') AS [SwopOutMachineID], NULLIF([MachineConditionID], N'''') AS [EquipConditionID], NULLIF([TakenFrother], N'''') AS [TakenFrother], NULLIF([TakenBeanLid], N'''') AS [TakenBeanL ... [truncated]';
    BEGIN TRY
        BEGIN TRAN;
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            NULLIF([TCCID], N'') AS [TCCID], NULLIF([CustomerID], N'') AS [ContactID], NULLIF([CompanyName], N'') AS [CompanyName], NULLIF([ContactFirstName], N'') AS [ContactFirstName], NULLIF([ContactAltFirstName], N'') AS [ContactAltFirstName], NULLIF([CityID], N'') AS [AreaID], NULLIF([EmailAddress], N'') AS [EmailAddress], NULLIF([AltEmailAddress], N'') AS [AltEmailAddress], NULLIF([CustomerTypeID], N'') AS [ContactTypeID], NULLIF([EquipTypeID], N'') AS [EquipTypeID], CASE WHEN NULLIF([TypicallySecToo], N'') IS NULL THEN NULL WHEN NULLIF([TypicallySecToo], N'') IN (N'1', N'-1', N'true', N'TRUE', N'yes', N'YES', N'Y', N'y') THEN 1 WHEN NULLIF([TypicallySecToo], N'') IN (N'0', N'false', N'FALSE', N'no', N'NO', N'N', N'n') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([TypicallySecToo], N'')) END AS [TypicallySecToo], NULLIF([PreferedAgentID], N'') AS [PreferedAgentID], NULLIF([SalesAgentID], N'') AS [SalesAgentID], CASE WHEN NULLIF([UsesFilter], N'') IS NULL THEN NULL WHEN NULLIF([UsesFilter], N'') IN (N'1', N'-1', N'true', N'TRUE', N'yes', N'YES', N'Y', N'y') THEN 1 WHEN NULLIF([UsesFilter], N'') IN (N'0', N'false', N'FALSE', N'no', N'NO', N'N', N'n') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([UsesFilter], N'')) END AS [UsesFilter], CASE WHEN NULLIF([enabled], N'') IS NULL THEN NULL WHEN NULLIF([enabled], N'') IN (N'1', N'-1', N'true', N'TRUE', N'yes', N'YES', N'Y', N'y') THEN 1 WHEN NULLIF([enabled], N'') IN (N'0', N'false', N'FALSE', N'no', N'NO', N'N', N'n') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([enabled], N'')) END AS [Enabled], NULLIF([AlwaysSendChkUp], N'') AS [AlwaysSendChkUp], NULLIF([ReminderCount], N'') AS [ReminderCount], CASE WHEN NULLIF([NextPrepDate], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([NextPrepDate], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([NextPrepDate], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([NextPrepDate], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([NextPrepDate], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([NextPrepDate], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([NextPrepDate], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([NextPrepDate], N'')), CAST(NULL AS datetime2(7))) END AS [NextPrepDate], CASE WHEN NULLIF([NextDeliveryDate], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([NextDeliveryDate], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([NextDeliveryDate], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([NextDeliveryDate], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([NextDeliveryDate], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([NextDeliveryDate], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([NextDeliveryDate], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([NextDeliveryDate], N'')), CAST(NULL AS datetime2(7))) END AS [NextDeliveryDate], NULLIF([NextCoffee], N'') AS [NextCoffee], NULLIF([NextClean], N'') AS [NextClean], NULLIF([NextFilter], N'') AS [NextFilter], NULLIF([NextDescal], N'') AS [NextDescal], NULLIF([NextService], N'') AS [NextService], NULLIF([RequiresPurchOrder], N'') AS [RequiresPurchOrder]
...
BEGIN
    PRINT N'About to execute (IdentityInsert=ON):';
    PRINT N'INSERT INTO [TempCoffeecheckupItemsTbl] ([TCIID], [ContactID], [ItemID], [ItemQty], [ItemPrepID], [ItemPackagingID], [AutoFulfill], [NextDateRequired], [RecurringOrderItemID]) SELECT NULLIF([TCIID], N'''') AS [TCIID], NULLIF([CustomerID], N'''') AS [ContactID], NULLIF([ItemID], N'''') AS [ItemID], NULLIF([ItemQty], N'''') AS [ItemQty], NULLIF([ItemPrepID], N'''') AS [ItemPrepID], NULLIF([ItemPackagID], N'''') AS [ItemPackagingID], CASE WHEN NULLIF([AutoFulfill], N'''') IS NULL THEN NULL WHEN NULLIF([AutoFulfill], N'''') IN (N''1'', N''-1'', N''true'', N''TRUE'', N''yes'', N''YES'', N''Y'', N''y'') THEN 1 WHEN NULLIF([AutoFulfill], N'''') IN (N''0'', N''false'', N''FALSE'', N''no'', N''NO'', N''N'', N''n'') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([AutoFulfill], N'''')) END AS [AutoFulfill], CASE WHEN NULLIF([NextDateRequired], N'''') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([NextDateRequired], N'''')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''''), 127), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''''), 126), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''''), 121), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''''), 103), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''''), 101), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N'''')), CAST(NULL AS datetime2(7))) END AS [NextDateRequired], NULLIF([ReoccurOrderID], N'''') AS [RecurringOrderItemID] FROM [AccessSrc].[TempCoffeecheckupItemsTbl];';
    BEGIN TRY
        BEGIN TRAN;
        ...
        SELECT
            NULLIF([TCIID], N'') AS [TCIID], NULLIF([CustomerID], N'') AS [ContactID], NULLIF([ItemID], N'') AS [ItemID], NULLIF([ItemQty], N'') AS [ItemQty], NULLIF([ItemPrepID], N'') AS [ItemPrepID], NULLIF([ItemPackagID], N'') AS [ItemPackagingID], CASE WHEN NULLIF([AutoFulfill], N'') IS NULL THEN NULL WHEN NULLIF([AutoFulfill], N'') IN (N'1', N'-1', N'true', N'TRUE', N'yes', N'YES', N'Y', N'y') THEN 1 WHEN NULLIF([AutoFulfill], N'') IN (N'0', N'false', N'FALSE', N'no', N'NO', N'N', N'n') THEN 0 ELSE TRY_CONVERT(bit, NULLIF([AutoFulfill], N'')) END AS [AutoFulfill], CASE WHEN NULLIF([NextDateRequired], N'') IS NULL OR LEN(LTRIM(RTRIM(NULLIF([NextDateRequired], N'')))) = 0 THEN NULL ELSE COALESCE(TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''), 127), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''), 126), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''), 121), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''), 103), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N''), 101), TRY_CONVERT(datetime2(7), NULLIF([NextDateRequired], N'')), CAST(NULL AS datetime2(7))) END AS [NextDateRequired], NULLIF([ReoccurOrderID], N'') AS [RecurringOrderItemID]
