    ...
    public class ContactsAccInfoRepository : RepositoryBase<ContactsAccInfo>
    {
        ...
        private static List<DBParameter> BuildParameters(ContactsAccInfo entity, bool includeId)
        {
            var parameters = new List<DBParameter>
            {
                ...
                new DBParameter { ParamName = "@PaymentTermID", DataValue = entity.PaymentTermID ?? (object)DBNull.Value, DataDbType = DbType.Int32 },
                ...
                new DBParameter { ParamName = "@PriceLevelID", DataValue = entity.PriceLevelID ?? (object)DBNull.Value, DataDbType = DbType.Int32 },
                new DBParameter { ParamName = "@InvoiceTypeID", DataValue = entity.InvoiceTypeID ?? (object)DBNull.Value, DataDbType = DbType.Int32 },
