...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            NULLIF([CustomerId], N'') AS [ContactID], NULLIF([LastCupCount], N'') AS [LastCupCount], [NextCoffeeBy] AS [NextCoffeeBy], [NextCleanOn] AS [NextCleanOn], [NextFilterEst] AS [NextFilterEst], [NextDescaleEst] AS [NextDescaleEst], [NextServiceEst] AS [NextServiceEst], NULLIF([DailyConsumption], N'') AS [DailyConsumption], NULLIF([FilterAveCount], N'') AS [FilterAveCount], NULLIF([DescaleAveCount], N'') AS [DescaleAveCount], NULLIF([ServiceAveCount], N'') AS [ServiceAveCount], NULLIF([CleanAveCount], N'') AS [CleanAveCount]
