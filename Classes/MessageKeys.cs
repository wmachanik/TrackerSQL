...
namespace TrackerSQL.Classes
{
    ...
    public static class MessageKeys
    {
        ...
        public static class WooCommerce
        {
            ...
            public const string MapTabGeneral = "WooCommerce.MapTabGeneral";
            public const string MapGeneralHelp = "WooCommerce.MapGeneralHelp";
            public const string MapGeneralCompanyModeLbl = "WooCommerce.MapGeneralCompanyModeLbl";
            public const string MapGeneralCompanyModeCareOf = "WooCommerce.MapGeneralCompanyModeCareOf";
            public const string MapGeneralCompanyModeUpdate = "WooCommerce.MapGeneralCompanyModeUpdate";
            public const string MapGeneralCompanyModeNote = "WooCommerce.MapGeneralCompanyModeNote";
            public const string ImportCompanyPromptTitle = "WooCommerce.ImportCompanyPromptTitle";
            public const string ImportCompanyPromptBody = "WooCommerce.ImportCompanyPromptBody";
            public const string ImportCompanyPromptCareOf = "WooCommerce.ImportCompanyPromptCareOf";
            public const string ImportCompanyPromptUpdate = "WooCommerce.ImportCompanyPromptUpdate";
            public const string ImportCompanyPromptConfirm = "WooCommerce.ImportCompanyPromptConfirm";
            public const string ImportCompanyPromptCancel = "WooCommerce.ImportCompanyPromptCancel";
            public const string MapGeneralNoteLineFormatLbl = "WooCommerce.MapGeneralNoteLineFormatLbl";
            public const string MapGeneralNoteLineSkuOnly = "WooCommerce.MapGeneralNoteLineSkuOnly";
            public const string MapGeneralNoteLineSkuAndName = "WooCommerce.MapGeneralNoteLineSkuAndName";
            public const string MapGeneralNoteLineFormatNote = "WooCommerce.MapGeneralNoteLineFormatNote";
            public const string MapGeneralNotePartOrderLbl = "WooCommerce.MapGeneralNotePartOrderLbl";
