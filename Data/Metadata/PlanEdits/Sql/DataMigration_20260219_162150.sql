...
WHERE t.name IN (N'AreaPrepDaysTbl', N'AreasTbl', N'AwayReasonTbl', N'ClosureDatesTbl', N'ContactsAccInfoTbl', N'ContactsAwayPeriodTbl', N'ContactsTbl', N'ContactTrackedServiceItemsTbl', N'ContactTypesTbl', N'EquipConditionsTbl', N'EquipTypesTbl', N'HolidayClosuresTbl', N'InvoiceTypesTbl', N'ItemGroupsTbl', N'ItemPackagingsTbl', N'ItemPrepTypesTbl', N'ItemServiceTypesTbl', N'ItemsTbl', N'ItemUnitsTbl', N'NextPrepDateByAreasTbl', N'PaymentTermsTbl', N'PeopleTbl', N'PriceLevelsTbl', N'RecurranceTypesTbl', N'RepairFaultsTbl', N'RepairStatusesTbl', N'SectionTypesTbl', N'SendCheckupEmailTextsTbl', N'SentRemindersLogTbl', N'SysDataTbl', N'TempCoffeecheckupCustomerTbl', N'TempCoffeecheckupItemsTbl', N'TempOrdersHeaderTbl', N'TempOrdersLinesTbl', N'TempOrdersTbl', N'TotalCountTrackerTbl', N'TrackedServiceItemsTbl', N'TransactionTypesTbl', N'UsedItemGroupsTbl', N'ContactUsageLinesTbl', N'ContactsUsageTbl', N'ContactsItemUsageTbl', N'RepairsTbl');
OPEN fk_cur;
