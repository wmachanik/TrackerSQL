...
<asp:Content ID="cntSystemToolsBdy" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlSystemTools" runat="server" CssClass="simpleForm page-tone-panel page-tone-tools">
        ...
        <asp:UpdatePanel ID="upnlSystemToolsButtons" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" ViewStateMode="Enabled">
            <ContentTemplate>
                <div class="responsive-layout-container tools-dashboard-layout">
                        ...
                        <div class="dashboard-links tools-dashboard">
                            <div class="dashboard-link tool-tone-reset">
                                <div class="dashboard-card">
                                    ...
                                    <p>Recalculate next area prep and delivery dates</p>
                            ...
                            <div class="dashboard-link tool-tone-holiday">
                                <div class="dashboard-card">
                                    ...
                                    <p>Manage roast and delivery closures</p>
                                    <asp:Button ID="btnHolidayClosures" runat="server" Text="Open" PostBackUrl="~/Tools/HolidayClosures.aspx"
                    ...
                    <div class="complex-form-section">
                        <h3>Customers &amp; next dates</h3>
                        <div class="dashboard-links tools-dashboard">
                            <div class="dashboard-link tool-tone-reset">
                                <div class="dashboard-card">
                                    <div class="tool-card-header">
                                        <img class="tool-card-icon" src="../images/imgButtons/Copilot_ResetPrepDate_32.png" alt="" />
                                        <h4>Recalc Prediction Averages</h4>
                                    </div>
                                    <p>Bulk NextCoffeeBy and daily average (prediction only)</p>
                                    <div class="tool-card-options">
                                        <asp:CheckBox ID="chkRecalcPredictionsStaleOnly" runat="server" Checked="true"
                                            Text="Only stale (NextCoffeeBy before last coffee delivery)"
                                            ToolTip="Recommended after the Order Done prediction bug — skips contacts already ahead of last delivery" />
                                    </div>
                                    <asp:Button ID="btnRecalcPredictions" runat="server" Text="Run"
                                        OnClick="btnRecalcPredictions_Click"
                                        ToolTip="Recalculate DailyConsumption and NextCoffeeBy from usage history" />
                                </div>
                            </div>
                            <div class="dashboard-link tool-tone-lastorder">
                                <div class="dashboard-card">
                                    ...
                                    <p>Sync DateLastDone from item usage (recurring only)</p>
                        ...
                        <div class="dashboard-links tools-dashboard">
                            ...
                            <div class="dashboard-link tool-tone-email">
                                <div class="dashboard-card">
                                    ...
                                    <p>Test SMTP and email settings</p>
                                    <asp:Button ID="btnEmailDiagnostics" runat="server" Text="Open" PostBackUrl="~/Tools/EmailDiagnostics.aspx"
                                        ToolTip="Test SMTP and email settings" />
                                </div>
                            </div>
                            <div class="dashboard-link tool-tone-sysdata">
                                <div class="dashboard-card">
